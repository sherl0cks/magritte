...
<head>
  ...
  <link rel="stylesheet" href="com.rhc.MagritteShowcase/css/patternfly.min.css">
  <link rel="stylesheet" href="com.rhc.MagritteShowcase/css/patternfly-additions.min.css">
</head>

<body>
<span id="badge">
  <img src="com.rhc.MagritteShowcase/images/uf_logo.png" alt="UberFire Logo" title="Powered By Uberfire"/>
</span>
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <div id="brand">
        <img src="com.rhc.MagritteShowcase/images/uf.png" alt="Uberfire UI Framework">
      </div>
    </div>
